                  ...
                  <tr key={tutor._id} className="hover:bg-gray-50 transition-colors">
                      ...
                      <div className="flex items-center">
                        ...
                        <div className="ml-4">
                          ...
                          <div className="text-sm text-gray-500 truncate max-w-xs">
                            {tutor.bio ? `${tutor.bio.substring(0, 50)}...` : "No bio"}
                          </div>
                        </div>
                      </div>
                    </td>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                      <div className="flex space-x-2">
                        <button 
                          className="text-blue-600 hover:text-blue-900 bg-blue-50 px-3 py-1 rounded-md text-xs font-medium transition-colors"
                          onClick={() => {
                            // View Profile action - you can implement this later
                        ...
                        <button 
                          className="text-green-600 hover:text-green-900 bg-green-50 px-3 py-1 rounded-md text-xs font-medium transition-colors"
                          onClick={() => {
                            // Book Session action - you can implement this later
